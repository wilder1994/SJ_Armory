                    ...
                    <form method="POST" action="{{ route('weapons.store') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2" enctype="multipart/form-data">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-5">
                                @for ($i = 1; $i <= 5; $i++)
                                    <label for="photo_{{ $i }}" class="block cursor-pointer">
                                        <input id="photo_{{ $i }}" name="photos[]" type="file" accept="image/*" class="hidden"
                                            data-preview-target="photo_preview_{{ $i }}" data-placeholder-target="photo_placeholder_{{ $i }}" />
                                        <div class="flex h-24 w-full items-center justify-center rounded border border-dashed border-gray-300 bg-gray-50 text-xs text-gray-500">
                                            <span id="photo_placeholder_{{ $i }}">{{ __('Seleccionar foto') }}</span>
                                            <img id="photo_preview_{{ $i }}" alt="Previsualizacion"
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <x-text-input id="permit_type" name="permit_type" type="text" class="mt-1 block w-full" value="{{ old('permit_type') }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="permit_expires_at" name="permit_expires_at" type="date" class="mt-1 block w-full" value="{{ old('permit_expires_at') }}" />
